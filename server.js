...
let connectionString = 'mongodb+srv://Nathan:abc@cluster0.lc4bq.mongodb.net/todo?retryWrites=true&w=majority'
...
if (req.headers.authorization == "Basic bGVhcm46MTIz") {
  next()
} else {
